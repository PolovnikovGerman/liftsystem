...
//            ),
        ...
        $this->dbforge->add_field('CONSTRAINT FOREIGN KEY (order_item_id) REFERENCES ts_order_items(order_item_id) on update cascade on delete cascade');
