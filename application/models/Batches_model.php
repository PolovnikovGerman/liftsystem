...
//            $row['batchnote']='<img src="/img/empty_square.png" alt="empty note"/>';
//            $row['batchnote_class']='';
//            $row['batchnote_title']='';
//            if ($row['batch_note']!='') {
//                $row['batchnote']='<img src="/img/lightblue_square.png" alt="Batch note"/>';
...
//    }
//
//    function get_batchsum_order($order_id) {
//        $this->db->select('sum(batch_amount) as batchsum');
//        $this->db->from('ts_order_batches');
//        $this->db->where('order_id',$order_id);
//        $res=$this->db->get()->row_array();
//        if (isset($res['batchsum'])) {
...
//            case 'm':
//            case 'd':
//                $duedate=$this->func->getVMDDueDate($date,$paymeth);
//                break;
//            case 'a':
//                $duedate=$this->func->getAmexDueDate($date,$paymeth);
//                break;
//            case 't':
...
//        }
//
//        $duedate=$this->func->businessdate($duedate);
//        return $duedate;
//
//    }
//
