...
//
//        $this->_DB_GREY->select('*');
//        $this->_DB_GREY->from('sb_configs');
//        $this->_DB_GREY->where('config_name',$config_name);
...
//            );
//
//            $out=$this->func->calculate_shipcost($options);
//
//            if (!$out['result']) {
...
//            );
//            /* Recalc Rates */
//            $shiplast=$this->func->recalc_rates($ship,$itemdat,$row['item_qty'],$cntdat['country_iso_code_2'], $shipaddr['country_id']);
//
...
//        $this->_DB_GREY->db_select();
//
//        $this->_DB_GREY->select('m.shipping_method_id, m.shipping_method_name, m.ups_code, m.default_rate, m.minimal_rate,
//            m.shipping_method_available, zm.method_dimens,zm.method_percent');
//        $this->_DB_GREY->from('sb_countries cnt');
//        $this->_DB_GREY->join('sb_shipzone_methods zm','cnt.zone_id=zm.shipzone_id');
//        $this->_DB_GREY->join('sb_shipping_methods m','m.shipping_method_id=zm.method_id');
//        $this->_DB_GREY->where('cnt.country_id',$country_id);
//        if ($option=='not_null') {
//            $this->_DB_GREY->where('m.default_rate != ',0);
//            $this->_DB_GREY->where('m.minimal_rate != ',0);
//        }
//        $this->_DB_GREY->order_by('m.sort');
//        $result = $this->_DB_GREY->get()->result_array();
//        return $result;
//    }
//
