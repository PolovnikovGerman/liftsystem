...
//    }
    ...
    private function _invoice_test($options, $file_out) {
        ...
        // $pdf->SetMargins(14,14,14);
        // Logo
        $pdf->ImageEps( $logoFile, $logoXPos, $logoYPos, $logoWidth, $logoHeight, 'http://www.bluetrack.com' );
        // Inv #
        $pdf->Image($invnumImg, $invnumXPos, $invnumYPos, $invnumWidth, $invnumHeigth);
        $pdf->SetXY(167, 10.8);
        $pdf->SetFont('','B',16.564429);
        $pdf->SetTextColor(0, 0, 255);
        $pdf->Cell(35.8,16,$options['order_num'],0,0,'C');
        ...
        $pdf->SetTextColor(0,0,255);
        $pdf->Text(23,39.88, '1-800-790-6090');
        $pdf->Text(5,45.88,'www.bluetrack.com', false, false, true, 0, 0, $align='', false, 'http://www.bluetrack.com');
        $pdf->SetTextColor(0,0,0);
        $pdf->SetFont('', '', 13.552714);
