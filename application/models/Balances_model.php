...
//    function get_calcdata($sort, $direction) {
//        $this->db->select('calc_id,description,monthsum as monthly, weeksum as weekly, (coalesce(monthsum,0)/4+coalesce(weeksum,0)) as quarta, coalesce(monthsum,0)*12+coalesce(weeksum,0)*52 as yearly',FALSE);
...
//    }
//
//    function get_calcrow_data($calc_id) {
//        /* Totals */
...
//    }
//
//    function save_calcdata($options) {
...
//    }
//
//    function delete_calcdata($calc_id) {
//        $this->db->where('calc_id',$calc_id);
        ...
        if (count($results)!=0) {
            ...
            if($radio == "amount") {
                ...
                if ($value<0) {
                    ...
                    $out['out_owners']=($prof_owners==0 ? $this->EMPTY_PROFIT : '$'.  number_format($prof_owners,0,'.',','));
                }*/
                $value=$prof_saved;
                if ($value<0) {
                ...
                if ($value<0) {
                    ...
                    $out['out_od2']=($prof_od2==0 ? $this->EMPTY_PROFIT : '$'.number_format($prof_od2,0,'.',','));
                }*/
                $value=$prof_od;
                if ($value<0) {
