...
//        );
//
//        $this->db->select('sum(netprofit_revenue(np.datebgn, np.dateend )) as revenue, sum(netprofit_profit(np.datebgn, np.dateend )) as gross_profit');
//        $this->db->select('sum(netprofit_cntsale(np.datebgn, np.dateend )) as sales, sum(np.profit_operating) as profit_operating');
...
//        $this->db->select('sum(netprofit_profit(np.datebgn, np.dateend)*np.debtinclude) as rungross',FALSE);
...
//        if ($type=='week') {
//            $this->db->where('np.profit_month is NULL');
//        } else {
//            $this->db->where('np.profit_week is NULL');
//        }
//        if (isset($options['start']) && $options['start']) {
//            $this->db->where('np.datebgn >= ',$options['start']);
//        }
//        if (isset($options['end']) && $options['end']) {
//            $this->db->where('np.dateend <= ',$options['end']);
//        }
//        if (isset($options['startweek']) && $options['startweek']) {
//            $this->db->where('np.profit_week >= ',$options['startweek']);
//        }
//        if (isset($options['endweek']) && $options['endweek']) {
//            $this->db->where('np.profit_week < ',$options['endweek']);
//        }
//        if (isset($options['datayear'])) {
//            $this->db->where('np.profit_year',$options['datayear']);
//        }
...
//            if($radio == "amount") {
//                $out['out_sales']=($prof_sales==0 ? Balances_model::EMPTY_PROFIT : number_format($prof_sales,0,'.',','));
//                $out['out_revenue']=($prof_revenue==0 ? Balances_model::EMPTY_PROFIT : '$'.number_format(floatval($prof_revenue),0,'.',','));
//                $out['out_profit']=($prof_gross_profit==0 ? Balances_model::EMPTY_PROFIT : '$'.number_format($prof_gross_profit,0,'.',','));
//                $out['out_profitperc']=($prof_revenue==0 ? '&nbsp;' : round($prof_gross_profit/$prof_revenue*100,0).'%');
//                $out['out_operating']=($prof_operating==0 ? Balances_model::EMPTY_PROFIT : '$'.number_format($prof_operating,0,'.',','));
//                $out['out_payroll']=($prof_payroll==0 ? Balances_model::EMPTY_PROFIT : '$'.  number_format($prof_payroll,0,'.',','));
//                $out['out_advertising']=($prof_advertising==0 ? Balances_model::EMPTY_PROFIT : '$'.  number_format($prof_advertising,0,'.',','));
//                $out['out_projects']=($prof_projects==0 ? Balances_model::EMPTY_PROFIT : '$'.  number_format($prof_projects,0,'.',','));
//                $out['out_purchases']=($prof_purchases==0 ? Balances_model::EMPTY_PROFIT : '$'.  number_format($prof_purchases,0,'.',','));
//                $out['out_w9work']=($prof_w9==0 ? Balances_model::EMPTY_PROFIT : MoneyOutput($prof_w9));
//                $out['out_totalcost']=($prof_total_cost==0 ? Balances_model::EMPTY_PROFIT : '$'.  number_format($prof_total_cost,0,'.',','));
//                $out['out_netprofit']=($prof_net_profit==0 ? Balances_model::EMPTY_PROFIT : '$'.  number_format($prof_net_profit,0,'.',','));
...
//                } else {
//                    $out['out_debt']=($prof_debt==0 ? Balances_model::EMPTY_PROFIT : '+$'.  number_format($prof_debt,0,'.',','));
//                    $out['out_debtclass']=($prof_debt==0 ? '' : 'color_blue2');
//                }
//                /*$value=$prof_owners;
//                if ($value<0) {
//                    $out['out_owners']='-$'.  number_format(abs($prof_owners),0,'.',',');
//                } else {
//                    $out['out_owners']=($prof_owners==0 ? Balances_model::EMPTY_PROFIT : '$'.  number_format($prof_owners,0,'.',','));
//                }*/
//                $value=$prof_saved;
//                if ($value<0) {
//                    $out['out_saved']='-$'.  number_format(abs($prof_saved),0,'.',',');
//                } else {
//                    $out['out_saved']=($prof_saved==0 ? Balances_model::EMPTY_PROFIT : '$'.  number_format($prof_saved,0,'.',','));
//                }
//                /*$value=$prof_od2;
//                if ($value<0) {
//                    $out['out_od2']='-$'.  number_format(abs($prof_od2),0,'.',',');
//                } else {
//                    $out['out_od2']=($prof_od2==0 ? Balances_model::EMPTY_PROFIT : '$'.number_format($prof_od2,0,'.',','));
//                }*/
//                $value=$prof_od;
//                if ($value<0) {
//                    $out['out_od'] = '-$'.number_format(abs($prof_od),0,'.',',');
//                } else {
//                    $out['out_od'] = ($prof_od == 0 ? Balances_model::EMPTY_PROFIT : '$'.number_format($prof_od,0,'.',','));
//                }
//            } else {
//                $out['out_sales']=($prof_sales==0 ? Balances_model::EMPTY_PROFIT : number_format($prof_sales,0,'.',','));
//                $out['out_revenue']=($prof_revenue==0 ? Balances_model::EMPTY_PROFIT : '$'.number_format(floatval($prof_revenue),0,'.',','));
//                $out['out_profit']=($prof_gross_profit==0 ? Balances_model::EMPTY_PROFIT : '$'.number_format($prof_gross_profit,0,'.',','));
//                $out['out_profitperc']=($prof_revenue==0 ? '&nbsp;' : round($prof_gross_profit/$prof_revenue*100,0).'%');
//                $out['out_operating']=(floatval($prof_operating)==0 ? Balances_model::EMPTY_PROFIT : round(abs($prof_operating/$prof_revenue)*100,0).'%');
//                $out['out_payroll']=(floatval($prof_payroll)==0 ? Balances_model::EMPTY_PROFIT : round(abs($prof_payroll/$prof_revenue)*100,0).'%');
//                $out['out_advertising']=(floatval($prof_advertising)==0 ? Balances_model::EMPTY_PROFIT : round(abs($prof_advertising/$prof_revenue)*100,0).'%');
//                $out['out_projects']=(floatval($prof_projects)==0 ? Balances_model::EMPTY_PROFIT : round(abs($prof_projects/$prof_revenue)*100,0).'%');
//                $out['out_purchases']=(floatval($prof_purchases)==0 ? Balances_model::EMPTY_PROFIT : round(abs($prof_purchases/$prof_revenue)*100,0).'%');
//                $out['out_w9work']=($prof_w9==0 ? Balances_model::EMPTY_PROFIT : round(abs($prof_w9/$prof_revenue)*100,0).'%');
//                $out['out_totalcost']='&nbsp;';
//                $out['out_netprofit']='&nbsp;';
//                $out['out_totalcostperc']=($prof_revenue==0 ? '&nbsp;' : round($prof_total_cost/$prof_revenue*100,0).'%');
//                $out['out_netprofitperc']=($prof_revenue==0 ? '&nbsp;' : round($prof_net_profit/$prof_revenue*100,0).'%');
...
//                }*/
//
//                $out['out_saved']=(floatval($prof_saved)==0 ? Balances_model::EMPTY_PROFIT : round(abs($prof_saved/$prof_revenue)*100,0).'%');
//
//                /*$value=$prof_od2;
//                if ($value<0) {
//                    $out['out_od2']='-$'.  number_format(abs($prof_od2),0,'.',',');
...
//                }*/
//
//                $out['out_od'] = (floatval($prof_od)==0 ? Balances_model::EMPTY_PROFIT : round(abs($prof_od/$prof_revenue)*100,0).'%');
//            }
//
//        }
//        return $out;
//    }
//
//    function get_netprofit_data($datebgn, $dateend, $order, $direc, $user_id, $radio, $limitshow=0) {
//        /* Get data about Weeks results and profit, revenue, num of sales */
//        $this->db->select('np.*, netprofit_revenue(np.datebgn, np.dateend) as revenue,
//            netprofit_profit(np.datebgn, np.dateend) as gross_profit,
//            netprofit_cntsale(np.datebgn, np.dateend) as sales, netprofit_cntproj(np.datebgn, np.dateend) as cntproj',FALSE);
//        $this->db->select('netprofit_totalcost(np.datebgn, np.dateend,1) as totalcost',FALSE);
//        $this->db->select('netprofit_netprofit(np.datebgn, np.dateend,1) as netprofit',FALSE);
//        $this->db->from('netprofit np');
//        $this->db->where('np.datebgn >= ',$datebgn);
//        $this->db->where('np.dateend <= ',$dateend);
//        $this->db->where('np.profit_month is NULL');
//        // $this->db->order_by('np.datebgn desc');
...
//            $this->db->where('order_date >= ',$dstart);
...
//            $row['week']=$weekname;
//            $row['out_revenue']=(floatval($row['revenue'])==0 ? Balances_model::EMPTY_PROFIT : MoneyOutput($row['revenue'],0));
//            $row['out_profit']=(floatval($row['gross_profit'])==0 ? Balances_model::EMPTY_PROFIT : MoneyOutput($row['gross_profit'],0));
//            $row['out_profitperc']=(floatval($row['revenue'])==0 ? '&nbsp;' : round($row['gross_profit']/$row['revenue']*100,0).'%');
//            $row['out_operating']=Balances_model::EMPTY_PROFIT;
//            $row['operating_class']='';
//            $row['out_payroll']=Balances_model::EMPTY_PROFIT;
//            $row['payroll_class']='';
//            $row['out_advertising']=Balances_model::EMPTY_PROFIT;
//            $row['advertising_class']='';
//            $row['out_projects']=Balances_model::EMPTY_PROFIT;
//            $row['projects_class']='';
//            $row['out_purchases']=Balances_model::EMPTY_PROFIT;
//            $row['purchases_class']='';
//            $row['out_w9']=Balances_model::EMPTY_PROFIT;
//            $row['w9work_class']='';
//            $row['out_totalcost']='Not Calc Yet';
//            $row['totalcost_class']='';
//            $row['out_netprofit']='Not Calc Yet';
//            $row['netprofit_class']='';
//            $row['out_debt']=Balances_model::EMPTY_PROFIT;
//            $row['debt_class']='';
//            $row['out_owners']=Balances_model::EMPTY_PROFIT;
//            $row['owners_class']='';
//            $row['saved_class']='';
//            // $row['sales']=Balances_model::EMPTY_PROFIT;
...
//                } else {
//                    $row['out_saved']=Balances_model::EMPTY_PROFIT;
//                }
//
//                $out_od = $od2 + $owners;
//                if(round($out_od,0)>0) {
...
//                } else {
//                    $row['out_od'] = Balances_model::EMPTY_PROFIT;
//                    $row['out_od_class'] = '';
//                }
//            } else {
//                if ($operating<0) {
//                    $row['out_operating']=(floatval($operating)==0 ? Balances_model::EMPTY_PROFIT : round(abs($operating/floatval($row['revenue']))*100,0).'%');
//                    $row['operating_class']='color_green';
//                } elseif ($operating>0) {
//                    $row['out_operating']='('.(floatval($operating)==0 ? Balances_model::EMPTY_PROFIT : round(abs($operating/floatval($row['revenue']))*100,0).'%').')';
//                    $row['operating_class']='color_red';
...
//
//                if ($payroll<0) {
//                    $row['out_payroll']=(floatval($payroll)==0 ? Balances_model::EMPTY_PROFIT : round(abs($payroll/floatval($row['revenue']))*100,0).'%');
//                    $row['payroll_class']='color_green';
//                } elseif ($payroll>0) {
//                    $row['out_payroll']='('.(floatval($payroll)==0 ? Balances_model::EMPTY_PROFIT : round(abs($payroll/floatval($row['revenue']))*100,0).'%').')';
//                    $row['payroll_class']='color_red';
...
//
//                if ($advertising<0) {
//                    $row['out_advertising']=(floatval($advertising)==0 ? Balances_model::EMPTY_PROFIT : round(abs($advertising/floatval($row['revenue']))*100,0).'%');
//                    $row['advertising_class']='color_green';
//                } elseif($advertising>0) {
//                    $row['out_advertising']='('.(floatval($advertising)==0 ? Balances_model::EMPTY_PROFIT : round(abs($advertising/floatval($row['revenue']))*100,0).'%').')';
//                    $row['advertising_class']='color_red';
...
//
//                if ($projects<0) {
//                    $row['out_projects']=(floatval($projects)==0 ? Balances_model::EMPTY_PROFIT : round(abs($projects/floatval($row['revenue']))*100,0).'%');
//                    $row['projects_class']='color_green';
//                } elseif($projects>0) {
//                    $row['out_projects']='('.(floatval($projects)==0 ? Balances_model::EMPTY_PROFIT : round(abs($projects/floatval($row['revenue']))*100,0).'%').')';
//                    $row['projects_class']='color_red';
//                }
//                if ($w9<0) {
//                    $row['out_w9']=(floatval($w9)==0 ? Balances_model::EMPTY_PROFIT : round(abs($w9/floatval($row['revenue']))*100,0).'%');
//                    $row['w9work_class']='color_green';
//                } elseif($w9>0) {
//                    $row['out_w9']='('.(floatval($w9)==0 ? Balances_model::EMPTY_PROFIT : round(abs($w9/floatval($row['revenue']))*100,0).'%').')';
//                    $row['w9work_class']='color_red';
...
//
//                if ($purchases<0) {
//                    $row['out_purchases']=(floatval($purchases)==0 ? Balances_model::EMPTY_PROFIT : round(abs($purchases/floatval($row['revenue']))*100,0).'%');
//                    $row['purchases_class']='color_green';
//                } elseif ($purchases>0) {
//                    $row['out_purchases']='('.(floatval($purchases)==0 ? Balances_model::EMPTY_PROFIT : round(abs($purchases/floatval($row['revenue']))*100,0).'%').')';
//                    $row['purchases_class']='color_red';
...
//                }
//                if (round($saved,0)>0) {
//                    $row['out_saved']=(floatval($saved)==0 ? Balances_model::EMPTY_PROFIT : round(abs($saved/floatval($row['revenue']))*100,0).'%');
//                    $row['saved_class']='color_blue2';
//                } elseif (round($saved,0)<0) {
//                    $row['out_saved']='('.(floatval($saved)==0 ? Balances_model::EMPTY_PROFIT : round(abs($saved/floatval($row['revenue']))*100,0).'%').')';
//                    $row['saved_class']='color_red';
...
//                $out_od = $od2 + $owners;
//                if(round($out_od,0)>0) {
//                    $row['out_od'] = (floatval($out_od)==0 ? Balances_model::EMPTY_PROFIT : round(abs($out_od/floatval($row['revenue']))*100,0).'%');
//                    $row['out_od_class'] = 'color_blue2';
//                } elseif (round($out_od,0)<0) {
//                    $row['out_od'] = '('.(floatval($out_od)==0 ? Balances_model::EMPTY_PROFIT : round(abs($out_od/floatval($row['revenue']))*100,0).'%').')';
//                    $row['out_od_class'] = 'color_red';
...
//    }
//
//    function get_netprofit_monthdata($datebgn, $dateend, $order, $direc, $user_id, $radio) {
//        $this->db->select('np.*, netprofit_revenue(np.datebgn, np.dateend) as revenue,
//            netprofit_profit(np.datebgn, np.dateend) as gross_profit,
//            netprofit_cntsale(np.datebgn, np.dateend) as sales, netprofit_cntproj(np.datebgn, np.dateend) as cntproj',FALSE);
//        $this->db->select('netprofit_totalcost(np.datebgn, np.dateend,0) as totalcost',FALSE);
//        $this->db->select('netprofit_netprofit(np.datebgn, np.dateend,0) as netprofit',FALSE);
//        $this->db->from('netprofit np');
//        $this->db->where('np.datebgn >= ',$datebgn);
//        $this->db->where('np.dateend <= ',$dateend);
...
//        }
//        /* Get number of weeks */
//        $this->db->select('TIMESTAMPDIFF(MONTH, from_unixtime('.$datebgn.'),from_unixtime('.($dateend+1).')) as nummonth');
//        $mres=$this->db->get()->row_array();
//        $nummonths=$mres['nummonth'];
//        if ($nummonths!=count($monthdat)) {
//            for ($i=0;$i<$nummonths;$i++) {
//                $date = strtotime(date("Y-m-d", $datebgn) . " +".$i." month");
//                $curmonth=date('m',$date);
//                $curyear=date('Y',$date);
//                $srchdate=$curmonth.'-'.$curyear;
//                if (!in_array($srchdate, $monthdat)) {
//                    array_push($monthdat, $srchdate);
...
//            $row['out_profitperc']=(floatval($row['revenue'])==0 ? '&nbsp;' : round($row['gross_profit']/$row['revenue']*100,0));
//            $row['profit_class']=(floatval($row['cntproj'])==0 ? '' : 'projprof');
//            $row['sales']=($row['sales']==0 ? Balances_model::EMPTY_PROFIT : number_format($row['sales'],0,'.',''));
...
//                $row['out_operating']=Balances_model::EMPTY_PROFIT;
//                if ($operating<0) {
//                    $row['out_operating']=($operating==0 ? Balances_model::EMPTY_PROFIT : MoneyOutput(abs($operating),0));
//                    $row['operating_class']='color_green';
//                } elseif ($operating>0) {
//                    $row['out_operating']='('.MoneyOutput($operating,0).')';
//                    $row['operating_class']='color_red';
...
//                }
//                $totalcost=$row['totalcost'];
//                $row['out_totalcost']=Balances_model::EMPTY_PROFIT;
//                $row['totalcost_class']='';
//                if ($totalcost<0) {
//                    $row['out_totalcost']=MoneyOutput(abs($totalcost),0);
//                    $row['totalcost_class']='color_green2';
...
//                }
//                $row['out_totalcostperc']=(floatval($totalcost)==0 ? '&nbsp;' : round(abs($totalcost/floatval($row['revenue']))*100,0).'%');
//                $row['out_netprofit']=  Balances_model::EMPTY_PROFIT;
//                $row['netprofit_class']='';
//                $netprofit=$row['netprofit'];
//                if ($netprofit>0) {
//                    $row['out_netprofit']=MoneyOutput($netprofit,0);
...
//                }
//                $row['od2_class']='';
//                $row['out_od2']=Balances_model::EMPTY_PROFIT;
//                if ($od2>0) {
...
//                $row['out_w9']=  Balances_model::EMPTY_PROFIT;
//                if ($w9work<0) {
//                    $row['out_w9']=(floatval($w9work)==0 ? Balances_model::EMPTY_PROFIT : round(abs($w9work/floatval($row['revenue']))*100,0).'%');
//                    $row['w9work_class']='color_green';
//                } elseif ($w9work>0) {
//                    $row['out_w9']='('.(floatval($w9work)==0 ? Balances_model::EMPTY_PROFIT : round(abs($w9work/floatval($row['revenue']))*100,0).'%').')';
//                    $row['w9work_class']='color_red';
...
//                $row['out_od_class']='';
//                if ($od2>0) {
//                    $row['out_od']=(floatval($od)==0 ? Balances_model::EMPTY_PROFIT : round(abs($od/floatval($row['revenue']))*100,0).'%');
//                    $row['out_od_class']='color_blue2';
//                } elseif ($od2<0) {
//                    $row['out_od']='('.(floatval($od)==0 ? Balances_model::EMPTY_PROFIT : round(abs($od/floatval($row['revenue']))*100,0).'%').')';
//                    $row['out_od_class']='color_red';
...
//            if ($operating<0) {
//                $out_array[$key]['out_operating']=($operating==0 ? Balances_model::EMPTY_PROFIT : '$'.number_format(abs($operating),2,'.',','));
...
//            } else {
//                $out_array[$key]['out_operating']=Balances_model::EMPTY_PROFIT;
//            }
//
//            if ($payroll<0) {
...
//            } elseif ($payroll>0) {
//                $out_array[$key]['out_payroll']=($payroll==0 ? Balances_model::EMPTY_PROFIT : '($'.number_format($payroll,2,'.',',').')');
//                $out_array[$key]['payroll_class']='color_red';
//            } else {
//                $out_array[$key]['out_payroll']=Balances_model::EMPTY_PROFIT;
//            }
//
//            if ($advertising<0) {
...
//            } else {
//                $out_array[$key]['out_advertising']=Balances_model::EMPTY_PROFIT;
//            }
//
//            if ($projects<0) {
...
//            } else {
//                $out_array[$key]['out_projects']=Balances_model::EMPTY_PROFIT;
//            }
//            if ($purchases<0) {
...
//            } else {
//                $out_array[$key]['out_purchases']=Balances_model::EMPTY_PROFIT;
//            }
//            $totalcost=$operating+$payroll+$advertising+$projects+$purchases;
//            if ($totalcost<0) {
...
//            } else {
//                $out_array[$key]['out_debt']=Balances_model::EMPTY_PROFIT;
//            }
//            if ($owners>0) {
...
//            } else {
//                $out_array[$key]['out_owners']=Balances_model::EMPTY_PROFIT;
//            }
//        }
//    }
//
//    function include_netprofit_debt($profit_id, $type) {
...
//    }
//
//    function get_netprofit($weekid, $type) {
...
//        if ($type=='week') {
//            $this->db->where('np.profit_week', intval($week));
//            $this->db->where('np.profit_month is NULL');
//        } else {
//            $this->db->where('np.profit_month', intval($month));
//            $this->db->where('np.profit_week is NULL');
//        }
//
//        $res=$this->db->get()->row_array();
...
//                $out_totalcost=($totalcost==0 ? Balances_model::EMPTY_PROFIT : '$'.number_format($totalcost,0,'.',','));
//                $netprofit=floatval($res['gross_profit'])-$totalcost;
//                $out_netprofit=($netprofit==0 ? Balances_model::EMPTY_PROFIT : '$'.number_format($netprofit,0,'.',','));
//            }
//
//            if ($type=='week') {
...
//    }
//
//    public function get_netprofit_dataedit($profit_id) {
...
//                $out_netprofit=($netprofit==0 ? Balances_model::EMPTY_PROFIT : '$'.number_format($netprofit,0,'.',','));
//            }
//            $out_w9=  Balances_model::EMPTY_PROFIT;
...
//                }
//            }
//            $out_purchase=Balances_model::EMPTY_PROFIT;
...
//    }
//
//    function get_week_note($week,$year,$type) {
//        $this->db->select('*');
//        $this->db->from('netprofit');
//        $this->db->where('profit_year',$year);
//        if ($type=='week') {
...
//            $this->db->where('profit_month is NULL');
//        } else {
//            $this->db->where('profit_month',$week);
//            $this->db->where('profit_week is NULL');
//        }
//        $res=$this->db->get()->row_array();
//        return $res;
//    }
//
//    function save_week_note($profit_id,$weeknote) {
...
//
//        // Build empty array
//        $this->db->select('date_format(from_unixtime(o.order_date),\'%x\') as orddat, count(o.order_id) as cnt', FALSE);
...
//        // Get Other params
//        $this->db->select('np.profit_year, sum(np.profit_operating) as operating');
...
//        }
//        $this->db->group_by('np.profit_year');
...
//        }
//        for ($i=1; $i<53; $i++) {
//            $dates=$this->func->getDatesByWeek($i, $year);
...
//        $this->db->from('netprofit np');
//        $this->db->where('np.profit_week is not NULL');
//        $this->db->where('np.profit_year', $prevyear);
...
//            $this->db->from('netprofit np');
//            $this->db->where('np.profit_week is not NULL');
//            $this->db->where('np.profit_year', $curyear);
//            $this->db->where('np.dateend < ', $now);
...
//    }
//
//    private function _purchase_details_save($details, $profit_id) {
//        foreach ($details as $drow) {
...
//    }
//
//    private function _w9work_details_save($details, $profit_id) {
//        foreach ($details as $drow) {
//            if (empty($drow['netprofit_category_id'])) {
//                $drow['netprofit_category_id']=NULL;
//            } else {
...
//    }
//
//    public function netprofit_details_save($netprofitdata, $usrid, $session_id) {
//        $out=array('result'=>$this->error_result, 'msg'=>'Record Not Found');
//        $profit_id=$netprofitdata['profit_id'];
//        // Get Old Data
//        $netprofit=$netprofitdata['netprofit'];
...
//        $this->_purchase_details_save($purchase_details, $profit_id);
//        $purchase_total=0;
...
//        $this->_w9work_details_save($w9work_details, $profit_id);
//        $w9work_total=0;
...
//    }
//
//    public function get_w9purchase_tabledata() {
//        // $now=strtotime('monday this week');
//        $now=$this->func->getDayOfWeek(date('W'), date('Y'),1);
//
//        $year=date('Y', $now);
...
//        );
//        // W9 Work
//        $w9array=$this->get_w9yeardetails($year);
//        $purcharray=$this->get_purchaseyeardetails($year);
...
//    }
//
//    public function get_w9yeardetails($year, $w9sortfld='amount_perc', $w9sortdir='desc') {
//        // $now=strtotime('monday this week');
//        $now=$this->func->getDayOfWeek(date('W'), date('Y'),1);
//        // Totals
...
////                $row['category_name']='Unclassified';
////            }
////            $row['amount_perc']=($totals==0 ? 0 : round($row['amount']/$totals*100,1));
//            $row['amount_class']='';
//            $row['amout_out']=Balances_model::EMPTY_PROFIT;
//            if ($row['amount']>0) {
...
//    }
//
//    public function get_purchaseyeardetails($year,$purchasesortfld='amount_perc', $purchasesortdir='desc') {
//        // $now=strtotime('monday this week');
//        $now=$this->func->getDayOfWeek(date('W'), date('Y'),1);
//
//        $this->db->select('sum(d.amount) amount');
...
//                    }
//                    $this->func->session($session_id, $sessiondata);
//                }
//            }
//        }
//        return $out;
...
//    }
//
//    public function get_netprofit_purchasedetails($profit_id) {
...
//        $res=$this->db->get()->row_array();
//        if ($res['cnt']>0) {
//            $this->db->select('c.category_name, d.vendor, d.amount, d.description');
//            $this->db->from('ts_netprofit_details d');
//            $this->db->join('ts_netprofit_categories c','c.netprofit_category_id=d.netprofit_category_id','left');
//            $this->db->where('d.profit_id', $profit_id);
//            $this->db->where('d.details_type','W9');
...
//                $amount_class='';
//                $amount=Balances_model::EMPTY_PROFIT;
//                if ($row['amount']<0) {
...
//    }
//
//    public function  get_expenses_details($category, $year) {
...
//            $out['type']=$type;
//            // Get details
//            $this->db->select('n.datebgn, n.dateend, d.amount, d.vendor, d.description');
//            $this->db->from('ts_netprofit_details d');
//            $this->db->join('netprofit n', 'n.profit_id=d.profit_id');
//            $this->db->where('n.profit_week is not null');
//            $this->db->where('dateend < ', $now);
...
//                $weekname.=','.date('Y', $row['datebgn']);
//                $amount_class='';
//                $amount_out=Balances_model::EMPTY_PROFIT;
//                if ($row['amount']>0) {
