<div class="billing_content1">
    <div class="billing_content1_line">
        ...
        <input type="text" readonly="readonly" class="billing_input3 input_border_gray billinginput leftalign"
    ...
    <div class="billing_content1_line">
        <div class="billingaddressbox">
            <input type="text" class="billing_input1 billinginput leftalign" readonly="readonly"
                   placeholder="First and Last Name" value="<?= $billing['customer_name'] ?>"/>
            <input type="text" class="billing_input2 billinginput leftalign" readonly="readonly"
                   placeholder="Company" value="<?= $billing['company'] ?>"/>
            <input type="text" class="billing_input4 billinginput leftalign" readonly="readonly"
                   id="billorder_line1" placeholder="Address 1" value="<?= $billing['address_1'] ?>"/>
            <input type="text" class="billing_input4 billinginput leftalign" readonly="readonly"
                   placeholder="Address 2" value="<?= $billing['address_2'] ?>"/>
            <input type="text" class="billing_input5 billinginput leftalign" readonly="readonly"
                   placeholder="City" value="<?= $billing['city'] ?>"/>
            <div id="billingstateselectarea" class="billingstateselectarea">
                <?php if (count($states)==0) { ?>
                    &nbsp;
                <?php } else { ?>
                    <select class="billing_select1" disabled="disabled">
                        <option value="">&nbsp;</option>
