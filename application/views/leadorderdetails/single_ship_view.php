        ...
        <div class="ship_tax_container">
            ...
            <div class="ship_tax_cont_bl2 viewdata">
                <div class="line">
                    ...
                    <div class="label <?=$shipadr['resident']==1 ? '' : 'shipblind'?>" id="residentlabel">Resident</div>
                </div>
                <div class="line">
                ...
                <div class="line">
                    <?php if (!empty($shipping['shipdoc1_link'])) : ?>
                        <div class="shipdocs_link view" data-shipdoc="1" data-link="<?=$shipping['shipdoc1_link']?>" data-source="<?=$shipping['shipdoc1_src']?>" title="<?=$shipping['shipdoc1_src']?>">
                    ...
                    <?php if (!empty($shipping['shipdoc2_link'])) : ?>
                        <div class="shipdocs_link view" data-shipdoc="2" data-link="<?=$shipping['shipdoc2_link']?>" data-source="<?=$shipping['shipdoc2_src']?>" title="<?=$shipping['shipdoc2_src']?>">
            ...
            <div class="taxdataarea <?=(empty($shipping['shipdoc1_link']) && empty($shipping['shipdoc2_link'])) ? 'noshipdocs' : ''?>">
