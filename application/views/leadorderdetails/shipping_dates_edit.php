...
<div class="datevalue">
    <?php if ($user_role=='masteradmin') { ?>
        <input type="text" class="input_border_gray rushpastvalue" readonly id="rushpast" value="<?=date('m/d/Y', $shipping['shipdate']) ?>"/>
    <?php } else { ?>
...
<div class="datevalue <?=$user_role=='masteradmin' ? '' : $shipping['arriveclass']?>" id="arrivedateoutvalue">
    <?php if ($user_role=='masteradmin') { ?>
        <input type="text" class="input_border_gray rushpastvalue <?=$shipping['arriveclass']?>" readonly id="arrivedatepast" value="<?=date('m/d/Y', $shipping['arrive_date']) ?>"/>
    <?php } else { ?>
