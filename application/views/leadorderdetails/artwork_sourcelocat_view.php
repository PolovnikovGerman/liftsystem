<div class="art_line1">
    <div class="art_line1_backgr1">&nbsp;</div>
    <div class="art_line1_backgr2 art_line1_text">
        <div class="art_block1 text_blue openlocation" data-artloc="<?=$artwork_art_id?>" data-arttype="<?=$art_type?>"><?=$artlabel?></div>
        <div class="art_block2">
            <input type="checkbox" class="input_checkbox" style="float: left;" <?=$edit==1 ? '' : 'disabled="disabled"'?>/>
            <input type="checkbox" class="input_checkbox" style="float: left;" <?=$edit==1 ? '' : 'disabled="disabled"'?>/>
        </div>
        <div class="art_block3 text_blue">&nbsp;</div>
    ...
    <div class="art_line1_backgr3">&nbsp;</div>
</div>
