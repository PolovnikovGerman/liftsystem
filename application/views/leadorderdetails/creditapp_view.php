<select class="pay_method_select1 input_border_gray" disabled="disabled">
...
<div class="pm_content3_tx1">Due:<br/>
    <input type="text" class="pay_method_input5 input_border_gray" readonly="readonly" value="<?=$credit_appdue==0 ? '' : date('m/d', $credit_appdue)?>"/>
</div>
