...
<div class="block_3">
    <div class="block_3_text">
        ...
        <!--  -->
        <input type="text" class="block_3_input input_border_black inputleadorddata" data-entity="order" id="ordercustomername"
               data-field="customer_name" value="<?=$customer_name?>" maxlength="41"/>
    </div>
</div>
