<div class="vendordetails-body">
    <div class="vendordata-tabs <?=$vendor['vendor_status']==1 ? 'active' : 'inactive'?>">
        <div class="vendor-tab current <?=$editmode?>" data-tab="profile">Profile</div>
        <div class="vendor-tab <?=$editmode?>" data-tab="login">Vend Login</div>
        <div class="vendor-tab <?=$editmode?>" data-tab="history">History</div>
        <div class="vendor-tab <?=$editmode?>" data-tab="items">Items</div>
    </div>
