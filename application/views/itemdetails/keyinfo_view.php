<div class="itemkeytextrow">
    ...
    <div class="itemkeytextval">
        <?php if ($item['item_id'] == 0) { ?>
            <input id="item_number" name="item_number" value="<?= $item['item_number'] ?>" style="width:66px;"/>
        <?php } else { ?>
            <?= $item['item_number'] ?>
        <?php } ?>
    </div>
...
<div class="itemkeytextrow">
    ...
    <div class="itemkeytextval">
        <?php if ($mode=='edit') { ?>
            <input id="item_lead_a" name="item_lead_a" value="<?= $item['item_lead_a'] ?>" style="width:15px;"/><?= ($item['item_lead_a'] == 1 ? ' day' : ' days') ?>
        <?php } else { ?>
...
<div class="itemkeytextrow">
    ...
    <div class="itemkeytextval">
        <?php if ($mode=='edit') { ?>
            <input id="item_lead_b" name="item_lead_b" value="<?= $item['item_lead_b'] ?>" style="width:15px;"/><?= ($item['item_lead_b'] == 1 ? ' day' : ' days') ?>
        <?php } else { ?>
...
<div class="itemkeytextrow">
    ...
    <div class="itemkeytextval">
        <?php if ($mode=='edit') { ?>
            <input id="item_lead_c" name="item_lead_c" value="<?= $item['item_lead_c'] ?>" style="width:15px;"/><?= ($item['item_lead_c'] == 1 ? ' day' : ' days') ?>
        <?php } else { ?>
...
<div class="itemkeytextrow">
    ...
    <div class="itemkeytextval">
        <?php if ($mode=='edit') { ?>
            <input id="item_material" name="item_material" value="<?= $item['item_material'] ?>" style="width:53px;"/>
        <?php } else { ?>
...
<div class="itemkeytextrow_white">
    <?php if ($mode=='edit') { ?>
        <input id="item_size" name="item_size" value="<?= $item['item_size'] ?>" style="width:103px;" />
    <?php } else { ?>
