<form id="specialcheckouteditform">
    <div class="itemspecialcheckout">
        ...
        <div class="specialcheckout_data">
            ...
            <select class="specialcheckout_selecttype" id="special_checkout" name="special_checkout">
        ...
        <div class="specialcheckout_options" style="display:<?=($special_checkout==0 ? 'none' : 'block')?>">
            <div class="specialcheckout_specialprices">
                <div class="specialcheckout_shipping">
                    Free Shipping <input type="checkbox" value="1" <?=($special_shipping==1 ? 'checked="checked"' : '')?> name="special_shipping" id="special_shipping"/>
                </div>
                <div class="specialcheckout_setup">
                    Setup Price
                    <input type="hidden" id="old_special_setup" value="<?=$special_setup?>"/>
                    <input type="text" class="specialsetupinpt" id="special_setup" name="special_setup" value="<?=$special_setup?>"/>
                </div>
            </div>
