    ...
    <div class="pototalsdataview">
        ...
        <div class="row mt-2">
            <div class="col-12 col-sm-12 col-md-12 col-lg-4 col-xs-4 pototals-toplacehead">
                ...
                <div class="row mt-2">
                    <div class="col-12">
                        <div class="pototals-unsign-tolalqty">10 TO PLACE</div>
                        <div class="pototals-unsign-tolalsum">$15,432</div>
                    </div>
                </div>
                <div class="row mt-1">
                    <div class="col-12">
                ...
                <div class="row mt-2">
                    <div class="col-12">
                        <div class="pototals-approved-tolalqty">5 TO APPROVE</div>
                        <div class="pototals-approved-tolalsum">$15,432</div>
                    </div>
                </div>
                <div class="row mt-1">
                    <div class="col-12">
                ...
                <div class="row mt-2">
                    <div class="col-12">
                        <div class="pototals-proof-tolalqty">2 TO PROOF</div>
                        <div class="pototals-proof-tolalsum">$15,432</div>
                    </div>
                </div>
                <div class="row mt-1">
                    <div class="col-12">
