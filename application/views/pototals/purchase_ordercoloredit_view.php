<div class="purchaseorder_popuparea">
    ...
    <div class="datarow">
        ...
        <div class="poeditleftpart">
            <div class="orderitemnameplace"><?=$itemcolor['item_qty']?>&nbsp;<?=$itemcolor['item_description']?>&nbsp;<?=$itemcolor['item_color']?></div>
        </div>
    </div>
    <div class="datarow">
        <div class="poeditlabel labelqty">QTY:</div>
        <div class="poeditinput itemqty">
            <input type="text" class="amountqtyinpt" value="<?=$amount['shipped']?>" placeholder="QTY">
        </div>
        <div class="poeditlabel labelprice">Price:</div>
        <div class="poeditinput itemprice">
            <input type="text" class="amountpriceinpt" value="<?=$amount['shipped_price']?>" placeholder="Price">
        </div>
