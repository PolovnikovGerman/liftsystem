<div class="artworksarea" data-artworkartid="<?=$artwork_art_id?>" data-contentview="repeat">
    <div class="artworkdata_content">
        <div class="artworkdata <?=$location_state?>" data-artworkartid="<?=$artwork_art_id?>">
            ...
            <div class="artworktextsource" data-artworkartid="<?=$artwork_art_id?>">
                <div class="artworkusrtxt">&nbsp;</div>
                <div class="artpopup_fontlabel">Repeat:</div>
                <div class="artpopup_fontval">
                    <input type="text" class="artrepeat" data-artworkartid="<?=$artwork_art_id?>" value="<?=$repeat_text?>" readonly="readonly"/>
                </div>
            </div>
