...
<div class="sectionbody metasection <?=$missinfo==0 ? '' : 'missinginfo'?>">
    <div class="itemparamlabel metatitle">Meta Title:</div>
    <div class="itemparamvalue metatitle <?=empty($item['item_meta_title']) ? 'missing_info' : ''?>" data-event="hover" data-css="itemdetailsballonbox" data-bgcolor="#FFFFFF" data-bordercolor="#000" data-position="right" data-textcolor="#000"
    ...
    <div class="content-row">
        ...
        <div class="itemparamvalue metakeywords <?=empty($item['item_metakeywords']) ? 'missing_info' : ''?>" data-event="hover" data-css="itemdetailsballonarea" data-bgcolor="#FFFFFF"
             data-bordercolor="#000" data-position="left" data-textcolor="#000" data-balloon="<?=$item['item_metakeywords']?>" data-timer="6000" data-delay="1000">
            <?=$item['item_metakeywords']?>
        </div>
    </div>
    <div class="content-row">
        ...
        <div class="itemparamvalue itemkeywords <?=empty($item['item_keywords']) ? 'missing_info' : ''?>" data-event="hover" data-css="itemdetailsballonarea" data-bgcolor="#FFFFFF"
             data-bordercolor="#000" data-position="left" data-textcolor="#000" data-balloon="<?=$item['item_keywords']?>" data-timer="6000" data-delay="1000">
            <?=$item['item_keywords']?>
        </div>
    </div>
</div>
