    ...
    <?php foreach ($locations as $location) { ?>
        <div class="locationsdatarow">
            ...
            <div class="locationname editmode">
                <input class="printlocationinpt locname" data-idx="<?=$location['item_inprint_id']?>" data-item="item_inprint_location" value="<?=htmlspecialchars_decode($location['item_inprint_location'])?>"/>
            </div>
            <div class="locationplace editmode">
                <input class="printlocationinpt locationsize" data-idx="<?=$location['item_inprint_id']?>" data-item="item_inprint_size" value="<?=htmlspecialchars_decode($location['item_inprint_size'])?>"/>
            </div>
