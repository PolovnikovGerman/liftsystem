...
<?php } else { ?>
    ...
    <?php foreach ($images as $image) { ?>
        ...
        <div class="optimages-slide-item">
            ...
            <div class="removeimage optimage" data-image="<?=$image['item_img_id']?>">
                <i class="fa fa-trash"></i>
            </div>
            <div class="content-row">
                <div class="imageorder">
                    <select class="optimageorderinpt" data-image="<?=$image['item_img_id']?>">
                ...
                <div class="imagecaption">
                    <input class="itemimagecaption optimage" data-image="<?=$image['item_img_id']?>" value="<?=$image['item_img_label']?>" placeholder="Enter Caption..."/>
                </div>
            </div>
        </div>
        <?php $numpp++;?>
