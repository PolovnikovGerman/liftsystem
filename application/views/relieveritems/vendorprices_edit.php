<div class="relievers_vendorprices">
    <div class="vendorqtypricesarea">
        ...
        <div class="content-row">
            ...
            <div class="vendorqtypriceqty editmode">
                <input class="vendordatapriceinpt itemprice" data-item="vendor_item_blankcost" value="<?=$venditem['vendor_item_blankcost']?>"/>
            </div>
            <?php foreach ($vendor_prices as $vendor_price) { ?>
                <div class="vendorqtypriceqty editmode">
        ...
        <div class="content-row">
            ...
            <div class="vendorqtypriceval editmode">
                <input class="vendordatapriceinpt itemprice" data-item="vendor_item_cost" value="<?=$venditem['vendor_item_cost']?>"/>
            </div>
            <?php foreach ($vendor_prices as $vendor_price) { ?>
                <div class="vendorqtypriceval editmode">
    ...
    <div class="vendorextrapricearea">
        <div class="vendorextraprice">
            ...
            <div class="vendorextrapricevalue editmode">
                <input class="vendordatapriceinpt itemprice" data-item="vendor_item_exprint" value="<?=$venditem['vendor_item_exprint']?>"/>
            </div>
        </div>
        <div class="vendorextraprice">
            <div class="vendorextrapricetitle">New Setup:</div>
            <div class="vendorextrapricevalue editmode">
                <input class="vendordatapriceinpt itemprice" data-item="vendor_item_setup" value="<?=$venditem['vendor_item_setup']?>"/>
            </div>
        </div>
        <div class="vendorextraprice repeatsetup">
            <div class="vendorextrapricetitle">Repeat Setup:</div>
            <div class="vendorextrapricevalue editmode">
                <input class="vendordatapriceinpt itemprice" data-item="vendor_item_repeat" value="<?=$venditem['vendor_item_repeat']?>"/>
            </div>
        </div>
    </div>
    <div class="vendorrusharea">
        ...
        <div class="vendorrush1rush">
            ...
            <div class="vendorrushprice editmode">
                <input class="vendordatapriceinpt itemprice" data-item="rush1_price" value="<?=$venditem['rush1_price']?>"/>
            </div>
        </div>
        <div class="vendorrush2rush">
            ...
            <div class="vendorrushtermtitle">biz days</div>
            <div class="vendorrushprice editmode">
                <input class="vendordatapriceinpt itemprice" data-item="rush2_price" value="<?=$venditem['rush2_price']?>"/>
            </div>
        </div>
    </div>
    <div class="vendorpantonearea">
        ...
        <div class="vendorpantoneprice editmode">
            <input class="vendordatapriceinpt itemprice" data-item="pantone_match" value="<?=$venditem['pantone_match']?>"/>
        </div>
    </div>
</div>