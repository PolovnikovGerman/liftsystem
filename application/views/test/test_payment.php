    ...
    <tr style="font-family: 'Helvetica Neue', 'Helvetica', Helvetica, Arial, sans-serif; box-sizing: border-box; font-size: 14px; margin: 0; padding: 0;">
        ...
        <td class="container" width="600"
            ...
            <div class="content"
                ...
                <img src="https://www.tutoria.de/img/email-footer-1.png" alt="">
                            ...
                            <table width="100%" cellpadding="0" cellspacing="0"
                                ...
                                <tr style="font-family: 'Helvetica Neue', 'Helvetica', Helvetica, Arial, sans-serif; box-sizing: border-box; font-size: 14px; margin: 0; padding: 0;">
                                    <td class="content-block"
                                        ...
                                        valign="top">
                                        Vielen Dank für deine Registrierung bei tutoria!<br>
                                        <br>
                                        Wir freuen uns, dich bei tutoria begrüßen zu können.
                                    </td>
                                </tr>
                                <tr style="font-family: 'Helvetica Neue', 'Helvetica', Helvetica, Arial, sans-serif; box-sizing: border-box; font-size: 14px; margin: 0; padding: 0;">
                                    <td class="content-block"
                                        style="font-family: 'Helvetica Neue', 'Helvetica', Helvetica, Arial, sans-serif; box-sizing: border-box; font-size: 14px; vertical-align: top; margin: 0; padding: 0 0 20px;"
                                        valign="top">
                                        Du musst nur noch eine Sache machen bevor du unsere Nachhilfelehrer erforschen
                                        kannst. Bitte bestätige deine E-Mail-Adresse indem du auf diesen Button oder auf
                                        den Link klickst:<br>
                                        <br>
                                    </td>
                                </tr>
                                ...
                                <tr style="font-family: 'Helvetica Neue', 'Helvetica', Helvetica, Arial, sans-serif; box-sizing: border-box; font-size: 14px; margin: 0; padding: 0;">
                                    <td class="content-block"
                                        style="font-family: 'Helvetica Neue', 'Helvetica', Helvetica, Arial, sans-serif; box-sizing: border-box; font-size: 14px; vertical-align: top; margin: 0; padding: 0 0 20px;"
                                        valign="top">
                                        Jetzt steht deinem Erfolg bei tutoria nichts mehr im Weg!<br>
                                        Falls du noch Fragen hast kannst du uns gerne unter info@tutoria.de oder 0800
                                        111 12 36 kontaktieren!<br>
                                        Dein tutoria Team
                                    </td>
                                </tr>
                            </table>
                ...
                <img src="https://www.tutoria.de/img/email-footer-2.png" alt="">
                <div class="footer"
