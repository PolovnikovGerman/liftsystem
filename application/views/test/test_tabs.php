...
<head>
    ...
    <title>Lift System::Welcome</title>
...
<!--    <link rel="stylesheet" href="https://maxcdn.bootstrapcdn.com/font-awesome/4.5.0/css/font-awesome.min.css">-->
    ...
    <script src="/js/adminpage/page.js?v=2.02450"></script>
    <script src="/js/jsflash/flash.js"></script>
    <script src="/js/mb_balloons/jquery.mb.balloon.js"></script>
    <script src="/js/adminpage/jquery.qtip.js?v=2.02450"></script>
</head>
<body>
    <header>
        ...
        <div class="maincontent relievers">
            ...
            <div class="maincontent_view">
                ...
                <div class="contentsubmenu">
                    <div class="contentsubmenu_item active">Searches</div>
                    <div class="contentsubmenu_item">Email Signup</div>
                    <div class="contentsubmenu_item">Coupons</div>
                </div>
