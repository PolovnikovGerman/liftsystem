...
<?php foreach ($quests as $quest): ?>
    <div class="datarow <?=$numpp%2==0 ? 'whitedatarow' : 'greydatarow' ?> <?=$curdate!==date('m/d/y', strtotime($quest['email_date'])) && $numpp > 0 ? 'topseparaterow' : ''?>" data-task="<?=$quest['email_id']?>">
        <?php if ($curdate!==date('m/d/y', strtotime($quest['email_date']))) :?>
            <?php $curdate = date('m/d/y', strtotime($quest['email_date'])); ?>
