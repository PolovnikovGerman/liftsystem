<div class="row">
    <div class="col-12 accreceiv-totalrefund">
        <div class="row">
            <div class="col-6 col-sm-5 col-md-5 accreceiv-totalrefund-title">Refunds to Customers:</div>
            <div class="col-5 col-sm-5 col-md-4 accreceiv-totalrefund-value">(<?=TotalOutput(abs($totalrefund))?>)</div>
        </div>
    </div>
</div>
<div class="row">
