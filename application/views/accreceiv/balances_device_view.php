<div class="row accreceiv-totals">
    <div class="col-6 accreceiv-totals-title">Owed to Us:</div>
    <div class="col-5 accreceiv-totals-value"><?=TotalOutput($totalown)?></div>
</div>
<div class="row accreceiv-totals">
    <div class="col-6 accreceiv-totals-title">Refunds Owed:</div>
    <div class="col-5 accreceiv-totals-value refund">(<?=TotalOutput(abs($totalrefund))?>)</div>
</div>
<div class="row accreceiv-totals">
    <div class="col-6 accreceiv-totals-title totalar">TOTAL AR:</div>
