...
<!--        --><?php //} ?>
        <div class="accreceiv-owndetails-headdue sigmasystem ownsort" data-sort="batch_due">Due</div>
...
<!--        --><?php //} ?>
        <div class="accreceiv-refunddetails-headorderdate sigmasystem refundsort" data-sort="order_date">Order Date</div>
