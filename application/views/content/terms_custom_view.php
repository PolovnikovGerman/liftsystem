...
<!--        <input class="term_maintitle" name="term_maintitle" readonly="readonly" value="--><?php //=ifset($data,'term_maintitle')?><!--"/>-->
<!--    </div>-->
<!--    <div class="content-row">-->
<!--        <div class="label term_smalltext">Main Body Text:</div>-->
<!--        <textarea class="term_smalltext" name="term_smalltext" readonly="readonly">--><?php //=ifset($data,'term_smalltext')?><!--</textarea>-->
<!--    </div>-->
<!--</div>-->
