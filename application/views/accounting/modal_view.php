...
<div class="modal fade" id="modalLeadOrder" tabindex="-1" role="dialog" aria-labelledby="modalLeadOrderLabel">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h4 class="modal-title" id="modalLeadOrderLabel">Enter PO Value</h4>
                <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
            </div>
            <div class="modal-body" style="float: left; width: 1244px"></div>
            <div class="modal-footer"></div>
        </div>
    </div>
</div>
