...
<div class="leadorder_datarow <?=($nrow%2==0 ? 'grey' : 'white')?> <?=$row['rowclass']?>" data-order="<?=$row['order_id']?>">
    ...
    <?php } else { ?>
        <div class="itemcolor <?=$row['itemcolorclass']?>" <?=$row['itemcolorclass']=='wide' ? 'title="'.$row['itemcolor'].'"' : ''?> ><?=$row['itemcolor']?></div>
    <?php } ?>    
