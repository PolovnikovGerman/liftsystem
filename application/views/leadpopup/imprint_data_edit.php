    ...
    <?php foreach ($imprints as $row) { ?>
        <?php if ($row['delflag']==0) { ?>
            <div class="items_table_line <?= $numpp % 2 == 0 ? '' : 'items_line_gray' ?>">
                <div class="items_content_item2 <?= $numpp == 0 ? 'text_green imprintdetails' : '' ?>" data-quoteitem="<?= $quote_item_id ?>">
                ...
                <div class="items_content_price_view bord_l <?=$row['imprint_price_class']?>" title="<?=$row['imprint_price_title']?>">
