                ...
                <div class="imprintlocdata <?=$row['active']==0 ? '' : 'active'?>" data-details="<?=$row['quote_imprindetail_id']?>">
                    <div class="imprintlocrow">
                        ...
                        <div class="imprintlocprices">
                            ...
                            <input type="text" class="imprintprice input_text_right" data-fldname="print_2" data-details="<?=$row['quote_imprindetail_id']?>" <?=$row['active']==0 ? 'disabled="disabled"' : (($row['num_colors']<2  || $row['num_colors']==5) ? 'disabled="disabled"' : '')?> value="<?=number_format(floatval($row['print_2']),2)?>"/>
                            <input type="text" class="imprintprice input_text_right" data-fldname="print_3" data-details="<?=$row['quote_imprindetail_id']?>" <?=$row['active']==0 ? 'disabled="disabled"' : (($row['num_colors']<3  || $row['num_colors']==5) ? 'disabled="disabled"' : '')?> value="<?=number_format(floatval($row['print_3']),2)?>"/>
                            <input type="text" class="imprintprice input_text_right" data-fldname="print_4" data-details="<?=$row['quote_imprindetail_id']?>" <?=$row['active']==0 ? 'disabled="disabled"' : (($row['num_colors']<4  || $row['num_colors']==5) ? 'disabled="disabled"' : '')?> value="<?=number_format(floatval($row['print_4']),2)?>"/>
                        </div>
                    </div>
                    <div class="imprintlocrow">
                        ...
                        <div class="imprintlocprices">
                            ...
                            <input type="text" class="imprintprice input_text_right" data-fldname="setup_2" data-details="<?=$row['quote_imprindetail_id']?>" <?=$row['active']==0 ? 'disabled="disabled"' : (($row['num_colors']<2 || $row['num_colors']==5) ? 'disabled="disabled"' : '')?> value="<?=number_format(floatval($row['setup_2']),2)?>"/>
                            <input type="text" class="imprintprice input_text_right" data-fldname="setup_3" data-details="<?=$row['quote_imprindetail_id']?>" <?=$row['active']==0 ? 'disabled="disabled"' : (($row['num_colors']<3 || $row['num_colors']==5) ? 'disabled="disabled"' : '')?> value="<?=number_format(floatval($row['setup_3']),2)?>"/>
                            <input type="text" class="imprintprice input_text_right" data-fldname="setup_4" data-details="<?=$row['quote_imprindetail_id']?>" <?=$row['active']==0 ? 'disabled="disabled"' : (($row['num_colors']<4 || $row['num_colors']==5) ? 'disabled="disabled"' : '')?> value="<?=number_format(floatval($row['setup_4']),2)?>"/>
                        </div>
                    </div>
                </div>
            <?php } ?>
