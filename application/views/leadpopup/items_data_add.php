    ...
    <?php foreach ($items as $row) { ?>
        <div class="items_table_line bord_b <?=($nrow%2==0 ? '' : 'items_line_gray')?>">
            <div class="items_content_add">
                <select class="addnewitem" data-quoteitem="<?=$quote_item_id?>">
            ...
            <div class="items_content_sub_total2 newitemcoloradd" data-item="<?=$row['item_id']?>" data-quoteitem="<?=$quote_item_id?>">
                <div class="items_content_addprint" data-quoteitem="<?=$quote_item_id?>">Print Details</div>
            </div>
            <div class="items_content_cancel" data-quoteitem="<?=$quote_item_id?>"><i class="fa fa-trash"></i></div>
        </div>
        <?php $nrow++;?>
    <?php } ?>
</div>