...
<!--                <option value="6" --><?php //=($data['lead_type']==6 ? 'selected="selected"' : '')?><!--Ordering Soon</option>-->
                <option value="1" <?=($data['lead_type'] == 1 || $data['lead_type']==6) ? 'selected="selected"' : '' ?>>Priority</option>
