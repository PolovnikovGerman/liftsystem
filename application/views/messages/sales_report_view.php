<div class="maintitle"><?= $brand == 'SR' ? 'StressRelievers' : 'Bluetrack/Stressballs' ?> orders</div>
...
<table style="width: 1100px; font-size: 13px; color: #000000; border: 1px solid #000;border-collapse: collapse;">
    ...
    <tr style="border: 1px solid #000000;">
        <th style="width: 12%; text-align: center;border: 1px solid #000000; background-color: #0000ff; color: #FFFFFF;">
            Dates
        </th>
        <th style="width: 10%; text-align: center;border: 1px solid #000000; background-color: #0000ff; color: #FFFFFF;">
            0-499 Piece Orders
        </th>
        <th style="width: 10%; text-align: center;border: 1px solid #000000; background-color: #0000ff; color: #FFFFFF;">
            500-999 Piece Orders
        </th>
        <th style="width: 10%; text-align: center;border: 1px solid #000000; background-color: #0000ff; color: #FFFFFF;">
            1000+ Piece Orders
        </th>
        <th style="width: 8%; text-align: center;border: 1px solid #000000; background-color: #0000ff; color: #FFFFFF;">
            Total Orders
        </th>
        <th style="width: 8%; text-align: center;border: 1px solid #000000; background-color: #0000ff; color: #FFFFFF;">
            Total Points
        ...
        <th style="width: 6%; text-align: center;border: 1px solid #000000; background-color: #000000; color: #FFFFFF;">
            Canceled Orders
        </th>
        <th style="width: 6%; text-align: center;border: 1px solid #000000; background-color: #000000; color: #FFFFFF;">
            Canceled Points
        ...
        <tr>
            ...
            <td style="text-align: center;border: 1px solid #000000;">
                <?php if ($total['total_500'] == 0) { ?>
                    &mdash;
                <?php } else { ?>
                    <b><?= $total['orders_500'] ?></b> <span class="bonusdetails"
                                                             style="color: #696969; font-size: 12px;"> x <?= $price_500 ?> = <?= $total['total_500'] ?></span>
                <?php } ?>
            </td>
            <td style="text-align: center;border: 1px solid #000000;">
                <?php if ($total['total_1000'] == 0) { ?>
                    &mdash;
                <?php } else { ?>
                    <b><?= $total['orders_1000'] ?></b> <span class="bonusdetails"
                                                              style="color: #696969; font-size: 12px;"> x <?= $price_1000 ?> = <?= $total['total_1000'] ?></span>
                <?php } ?>
            </td>
            <td style="text-align: center;border: 1px solid #000000;">
                <?php if ($total['total_1200'] == 0) { ?>
                    &mdash;
                <?php } else { ?>
                    <b><?= $total['orders_1200'] ?></b> <span class="bonusdetails"
                                                              style="color: #696969; font-size: 12px;"> x <?= $price_1200 ?> = <?= $total['total_1200'] ?></span>
                <?php } ?>
            </td>
            ...
            <td style="text-align: center;border: 1px solid #000000;">
                <b><?= $total['cancel_values'] == 0 ? '&mdash;' : MoneyOutput($total['cancel_values']) ?></b></td>
        </tr>
    <?php } ?>
            ...
            <tr>
                ...
                <td style="text-align: center;border: 1px solid #000000;">
                    <?php if ($row['total_500'] == 0) { ?>
                        &mdash;
                    <?php } else { ?>
                        <b><?= $row['orders_500'] ?></b> <span class="bonusdetails"
                                                               style="color: #696969; font-size: 12px;"> x <?= $price_500 ?> = <?= $row['total_500'] ?></span>
                    <?php } ?>
                </td>
                <td style="text-align: center;border: 1px solid #000000;">
                    <?php if ($row['total_1000'] == 0) { ?>
                        &mdash;
                    <?php } else { ?>
                        <b><?= $row['orders_1000'] ?></b> <span class="bonusdetails"
                                                                style="color: #696969; font-size: 12px;"> x <?= $price_1000 ?> = <?= $row['total_1000'] ?></span>
                    <?php } ?>
                </td>
                <td style="text-align: center;border: 1px solid #000000;">
                    <?php if ($row['total_1200'] == 0) { ?>
                        &mdash;
                    <?php } else { ?>
                        <b><?= $row['orders_1200'] ?></b> <span class="bonusdetails"
                                                                style="color: #696969; font-size: 12px;"> x <?= $price_1200 ?> = <?= $row['total_1200'] ?></span>
                    <?php } ?>
                </td>
                ...
                <td style="text-align: center;border: 1px solid #000000;"><b><?= MoneyOutput($row['week_pay']) ?></b>
                </td>
                <td style="text-align: center;border: 1px solid #000000;">
                ...
                <td style="text-align: center;border: 1px solid #000000;">
                    <b><?= $row['cancel_values'] == 0 ? '&mdash;' : MoneyOutput($row['cancel_values']) ?></b></td>
            </tr>
        <?php } ?>
