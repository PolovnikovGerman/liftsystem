...
<div class="vendorextrapricearea">
    <div class="vendorextraprice">
        ...
        <div class="vendorextrapricevalue"><?= empty($venditem['vendor_item_exprint']) ? '' : PriceOutput($venditem['vendor_item_exprint']) ?></div>
    </div>
    <div class="vendorextraprice">
        <div class="vendorextrapricetitle">New Setup:</div>
        <div class="vendorextrapricevalue"><?= empty($venditem['vendor_item_setup']) ? '' : PriceOutput($venditem['vendor_item_setup']) ?></div>
    </div>
    <div class="vendorextraprice repeatsetup">
        <div class="vendorextrapricetitle">Repeat Setup:</div>
        <div class="vendorextrapricevalue"><?= empty($venditem['vendor_item_repeat']) ? '' : PriceOutput($venditem['vendor_item_repeat']) ?></div>
    </div>
</div>
<div class="vendorrusharea">
    ...
    <div class="vendorrush1rush">
        ...
        <div class="vendorrushterm"><?=$item['item_lead_b']?></div>
            <!-- $venditem['rush1_days'] -->
        <div class="vendorrushtermtitle">biz days</div>
        <div class="vendorrushprice"><?= empty($venditem['rush1_price']) ? ''  : PriceOutput($venditem['rush1_price']) ?></div>
    </div>
    <div class="vendorrush2rush">
        ...
        <div class="vendorrushterm"><?=$item['item_lead_c']?></div>
            <!-- $venditem['rush2_days'] -->
        <div class="vendorrushtermtitle">biz days</div>
        <div class="vendorrushprice"><?=empty($venditem['rush2_price']) ? ''  : PriceOutput($venditem['rush2_price']) ?></div>
    </div>
</div>
<div class="vendorpantonearea">
    <div class="vendorpantonetitle">Pantone Match</div>
    <div class="vendorpantoneprice"><?=empty($venditem['pantone_match']) ? ''  : PriceOutput($venditem['pantone_match']) ?></div>
</div>
