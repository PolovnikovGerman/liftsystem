    ...
    <div class="vendormainbody <?=$missinfo==0 ? '' : 'missinginfo'?>"">
        <div class="content-row">
            ...
            <div class="itemparamvalue editmode vendorname">
                <select class="vendornameinp <?=empty($vendor_item['vendor_item_vendor']) ? 'missing_info' : ''?>" data-item="vendor_item_vendor">
                    <option value=""></option>
        ...
        <div class="content-row">
            ...
            <div class="itemparamvalue vendorcountry editmode">
        ...
        <div class="content-row">
            ...
            <div class="itemparamvalue vendorponote editmode">
