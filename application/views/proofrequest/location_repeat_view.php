    ...
    <div class="artw-row">
        <div class="artw-linebox <?=$location['ready']==1 ? 'lightgreen' : 'white'?>">
            ...
            <div class="artw-srclabel">
                <div class="artw-srcrepeat">
                    <div class="artw-srcrepeat-txt">Repeat:</div>
                    <div class="artw-srcrepeat-inp">
                        <input type="text" name="artw-srcfont-inp" class="proofreqestlocation" data-art="<?=$location['artwork_art_id']?>" data-fld="repeat_text" value="<?=$location['repeat_text']?>"/>
                    </div>
                </div>
            </div>
