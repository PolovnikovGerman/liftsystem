...
//                }
    ...
    public function save_relive_addimage() {
        if ($this->isAjax()) {
            ...
            $sessiondata = usersession($session);
            if (!empty($sessiondata)) {
                $res = $this->items_model->itemdetails_save_addimages($sessiondata, $postdata, $session);
                $error = $res['msg'];
                if ($res['result']==$this->success_result) {
                    $error = '';
                    $sessiondata = usersession($session);
    ...
    public function save_relive_updaddimage() {
        if ($this->isAjax()) {
            ...
            $sessiondata = usersession($session);
            if (!empty($sessiondata)) {
                $res = $this->items_model->itemdetails_save_updimages($sessiondata, $postdata, $session);
                $error = $res['msg'];
                if ($res['result']==$this->success_result) {
                    $error = '';
                    $sessiondata = usersession($session);
    ...
    public function save_relive_addimagesort() {
        if ($this->isAjax()) {
            ...
            $sessiondata = usersession($session);
            if (!empty($sessiondata)) {
                $res = $this->items_model->itemdetails_save_imagessort($sessiondata, $postdata, $session);
                $error = $res['msg'];
                if ($res['result']==$this->success_result) {
                    $error = '';
                    $sessiondata = usersession($session);
    ...
    public function save_relive_addimagedel() {
        if ($this->isAjax()) {
            ...
            $sessiondata = usersession($session);
            if (!empty($sessiondata)) {
                $res = $this->items_model->itemdetails_addimages_delete($sessiondata, $postdata, $session);
                $error = $res['msg'];
                if ($res['result']==$this->success_result) {
                    $error = '';
                    $sessiondata = usersession($session);
    ...
    public function save_relive_addimagetitle() {
        if ($this->isAjax()) {
            ...
            $sessiondata = usersession($session);
            if (!empty($sessiondata)) {
                $res = $this->items_model->itemdetails_addimages_title($sessiondata, $postdata, $session);
                $error = $res['msg'];
                if ($res['result']==$this->success_result) {
                    $error = '';
                }
    ...
    public function save_relive_optimagesort() {
        if ($this->isAjax()) {
            ...
            $sessiondata = usersession($session);
            if (!empty($sessiondata)) {
                $res = $this->items_model->itemdetails_save_optimagessort($sessiondata, $postdata, $session);
                $error = $res['msg'];
                if ($res['result']==$this->success_result) {
                    $error = '';
                    $sessiondata = usersession($session);
    ...
    public function save_relive_optimagedel() {
        if ($this->isAjax()) {
            ...
            $sessiondata = usersession($session);
            if (!empty($sessiondata)) {
                $res = $this->items_model->itemdetails_optimages_delete($sessiondata, $postdata, $session);
                $error = $res['msg'];
                if ($res['result']==$this->success_result) {
                    $error = '';
                    $sessiondata = usersession($session);
    ...
    public function save_relive_optimagetitle() {
        if ($this->isAjax()) {
            ...
            $sessiondata = usersession($session);
            if (!empty($sessiondata)) {
                $res = $this->items_model->itemdetails_optimages_title($sessiondata, $postdata, $session);
                $error = $res['msg'];
                if ($res['result']==$this->success_result) {
                    $error = '';
                }
